...
## `r fontawesome::fa("triangle-exclamation", "white")` Functions need a object call, for example, `x` or a `return(x)` in order to return output from `x` to outside the function {.center background-color="#447099"}
