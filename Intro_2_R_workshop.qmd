...
> Functions are like a grammatically correct sentences; they require a function name, argument and body.
...
## `r fontawesome::fa("triangle-exclamation", "white")` Functions need an object call (i.e. `x` or a `return(x)`) in order to return output from `x` to the global environment {.center background-color="#447099"}.
