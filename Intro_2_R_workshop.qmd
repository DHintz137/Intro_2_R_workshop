...
-   `if`, `else`, `for`,`while`
-   if you could cover, or provide a table (with their uses) of the following infix operators `$`, `^`, `*`, `/`, `+`, `-`, `>`, `>=`, `<`, `<=`, `==`, `!=`, `!`, `&`, `&&`, `|`, `||`, `<-`
-   Add slides as you see fit
...
::: panel-tabset
Write a function named `scale_columns` that takes a matrix and scales (normalizes) each column to have a mean of 0 and a standard deviation of 1. \### Answer
