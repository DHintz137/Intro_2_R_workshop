...
title-slide-attributes: 
  data-footer: "My custom footer content"
...
> Functions are like a grammatically correct sentences; they require arguments, a body, and an environment^[See Hadley's section on [function-fundamentals](https://adv-r.hadley.nz/functions.html#function-fundamentals) for more detials].
...
# all other environments sits on top of the global environments 
```
...
L    # now we also print L from global environment
...
- The \``...`\` argument is also known as a Ellipsis or simply dot-dot-dot.
